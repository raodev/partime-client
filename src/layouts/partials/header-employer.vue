<template>
    <ul class="navigation-menu">
        ...
        <li class="has-submenu active">
            <a href="#"><i class="fi-air-play"></i>Tin tuyển dụng</a>
            <ul class="submenu">
                <li class="active">
                    <router-link to="/dashboard/add-job">
                        Đăng tin mới
                    </router-link>
                </li>
                <li>
            ...
            <ul class="submenu megamenu">
                ...
                <li>
                    <ul>
                        ...
                        </li><li><a href="ui-video.html">Video</a>
                    </li><li><a href="ui-tooltips-popovers.html">Tooltips &amp; Popovers</a></li>
